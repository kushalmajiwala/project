<script>
    ...
    async function generateLetterPDFFormat2(lid) {
            ...
            .then(function (response) {
                if (response.data.length == 0) {
                    ...
                    if (response.data[0].format == "one") {
                        ...
                        setTimeout(function () {
                            generateLetterPDFFormat2(download_letterid);
                        }, 1000);
                    }
                }
            })
                ...
                >
                        <div class="header-content">
                            <div class="letter-header-second">
                                <p class="name-box">{ letter_fname[0] } { letter_lname[0] }</p>
                                <p >{letter_fname}</p>
                                <p style="margin-top: -15%;">{letter_lname}</p>
                            </div>
                            <div class="personal-info-second">
                                <p class="context" style="font-size: 30px; font-weight:600;">Contact</p>
                                <p class="context"><i class="bi bi-envelope-check-fill" /> {letter_email}</p>
